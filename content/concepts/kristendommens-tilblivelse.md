# Kristendommens første århundrer — historisk kontekst
...
Pedersen understreker en viktig transformasjon allerede i kristendommens *første* generasjon: Jesus virket i en *landlig* galileisk kontekst. Paulus og den tidlige misjonen var dypt *urban*.
...
## Det apostolske skillet: 30–70 e.Kr.

Den *apostolske tid* (ca. 30–70) er perioden da de som hadde møtt Jesus personlig, fremdeles levde. Etter Jesu korsfestelse (ca. 30) samlet disiplene seg om troen på ham som oppstanden. Pinsedagen (Apg 2) markerte menighetens offentlige begynnelse.

I denne perioden dominerer to spørsmål kirkehistorien:

**Forholdet til jødedommen:** De kristne begynte som en jødisk gruppe i konflikt med andre jøder — primært fariseerne. Etter hvert som hedninger strømmet inn, ble spenningen mellom «jødekristent» og «hedningekristent» en grunnleggende utfordring (Gal 2, Apg 15).

**Forfølgelse:** Under Nero (64) ble kristne for første gang gjort til syndebukker for en storbrann i Roma og massehenrettet. Forfølgelse ble et gjennomgangstema som preget kristendommens selvforståelse i generasjoner.

---

## Det etterapostolske skillet: 70–140 e.Kr.

*Den etterapostolske tid* begynner med tre dramatiske hendelser rundt år 70:

- De fleste av dem som hadde møtt Jesus personlig, var døde
...
## Sammenhengen med Romerriket

Kristendommen forholdt seg til Romerriket på to måter i de første to hundre år:
...
- [[concepts/kirkehistorie-0-100]] — de første 100 år i detalj
- [[concepts/kirkehistorie-100-200]] — apologetenes tid
- [[concepts/apostoliske-fedre]] — litteraturen fra den etterapostolske tid
- [[concepts/evangeliene]] — evangelienes tilblivelse i denne perioden
- [[concepts/statsreligion]] — veien fra forfølgelse til statsreligion
- [[concepts/martyriet]] — forfølgelsenes historiske kontekst

---

## Kilder

- [[sources/Pedersen-2012-oldkirken]] — Pedersen, N.A. (2012): *Kirkens historie. Oldkirken*, kap. 1: «Kristendommens tilblivelse», s. 1–30. Anis
- [[sources/TEOL2310-teologihistorie-oldkirken]] — parallell fremstilling
